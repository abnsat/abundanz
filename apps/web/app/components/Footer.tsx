...
const SOCIALS = [
  {
    label: 'Facebook',
    href: 'https://bassimygorialabn12.wixstudio.com/abnfacebook',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://bassimygorialabn12.wixstudio.com/abninstagram',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'TikTok',
    href: 'https://bassimygorialabn12.wixstudio.com/abntiktok',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'Twitter / X',
    href: 'https://bassimygorialabn12.wixstudio.com/abntwitter',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'Telegram',
    href: 'https://bassimygorialabn12.wixstudio.com/abntelegram',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'YouTube',
    href: 'https://bassimygorialabn12.wixstudio.com/abnyoutube2',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
